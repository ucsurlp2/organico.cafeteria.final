...
<head>
    ...
    <title>Inventario - Orgánico Cafeteria</title>
    ...
    <!-- Contenido principal -->
        ...
        <div class="acciones-inventario">
            ...
            <form action="agregar-cat.jsp" method="get">
                <button class="boton agregar-categoria">Agregar Nueva Categoría</button>
            </form>
    ...
    <div id="modal" class="modal">
        <div class="modal-content">
            ...
            <form action="Controlador">
                ...
                <a href="inventario.html" class="regresar">Regresar</a>
            </form>
        </div>
    </div>
